...
create_rc_corner -name bc_Tm40c_cmin \
		 -qx_tech_file "$TECHLIBBASE/tch/bicmos8hp_7AM_41_SigCmin.tch" \
		 -T -40
...
create_rc_corner -name wc_T125c_cmax \
		 -qx_tech_file "$TECHLIBBASE/tch/bicmos8hp_7AM_41_SigCmax.tch" \
		 -T 125
...
create_rc_corner -name nom_T25c \
                 -qx_tech_file "$TECHLIBBASE/tch/bicmos8hp_7AM_41_nm.tch" \
		 -T 25
