...
#Comandos:
#source /opt/cds/cds.sh
#genus


set DESIGN	tpu;				#name of toplevel module
set LAYDIR	layout;				#name of Encounter file export folder
set SYNDIR	synth;				#synthesis log and reports root dir name	
set RPTDIR	rpt;				#report dir name
set LOGDIR	log;				#RC log dir name
set HDL_FILES [list tpu.sv ]
